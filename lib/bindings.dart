...
class llama {
  ...
  late final _api_promptPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<llama_chat_message>, ffi.Size,
              ffi.Pointer<dart_output>)>>('api_prompt');
  late final _api_prompt = _api_promptPtr.asFunction<
      int Function(
          ffi.Pointer<llama_chat_message>, int, ffi.Pointer<dart_output>)>();
  ...
  late final _api_stopPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('api_stop');
  late final _api_stop = _api_stopPtr.asFunction<void Function()>();
  ...
  late final _api_resetPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('api_reset');
  late final _api_reset = _api_resetPtr.asFunction<void Function()>();
  ...
  late final _api_freePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('api_free');
  late final _api_free = _api_freePtr.asFunction<void Function()>();
}
...
final class grammar_lazy_sampling_params extends ffi.Struct {
  ...
  external ffi.Pointer<llama_token> trigger_tokens;
